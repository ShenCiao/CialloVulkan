...
ciallo::vulkan::Instance::~Instance()
{
	m_instance->destroyDebugUtilsMessengerEXT(m_debugMessenger, nullptr, m_dldi);
}

VkBool32 ciallo::vulkan::Instance::debugCallback(VkDebugUtilsMessageSeverityFlagBitsEXT messageSeverity,
...
void ciallo::vulkan::Instance::create()
{
...
void ciallo::vulkan::Instance::addInstanceExtensions(std::vector<const char*> extensions)
{
